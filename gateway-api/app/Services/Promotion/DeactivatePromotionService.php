 ...
 */
class DeactivatePromotionService extends BaseService
{
    ...
    protected function execute(...$args): array
    {
        ...
        // 이미 비활성화된 경우 검증
        $this->promotionValidator->validatePromotionActive($promotion);

        // 프로모션 비활성화
        $this->promotionRepo->updateActiveStatus($promotionCode, 0);
