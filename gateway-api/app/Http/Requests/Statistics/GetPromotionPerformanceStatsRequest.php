 ...
 */
class GetPromotionPerformanceStatsRequest extends FormRequest
{
    /**
     * 권한 검증
     *
    ...
    public function messages(): array
    {
        return [
            ...
            "promotion_code.string" => __("messages.validation.statistics.promotion_code.string"),
            "promotion_code.max" => __("messages.validation.statistics.promotion_code.max")
        ];
    }
